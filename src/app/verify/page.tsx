		...
		<div className="container mx-auto max-w-4xl py-12">
					...
					<div className="grid gap-6 md:grid-cols-2">
						<div>
							...
							<p className="text-muted-foreground text-sm">
								When you vote, you receive a unique cryptographic hash for each
								ballot. Save this hash in your receipt.
							</p>
						</div>
						...
						<div>
							...
							<p className="text-muted-foreground text-sm">
								Copy and paste your vote hash into the verification form above.
								You can verify one or multiple hashes at once.
							</p>
						</div>
						...
						<div>
							...
							<p className="text-muted-foreground text-sm">
								The system will confirm whether your hash exists in our database
						...
						<div>
							...
							<p className="text-muted-foreground text-sm">
								If your hash is found, your vote was successfully counted in the
								election. Your anonymity is preserved.
							</p>
						</div>
					</div>
			...
			<Card className="mt-8">
				...
				<CardContent className="space-y-4">
					<div>
						<h4 className="mb-1 font-semibold">What if I lost my vote hash?</h4>
						<p className="text-muted-foreground text-sm">
							Vote hashes are only shown immediately after voting. If you didn't
							save your receipt, you can still confirm that you voted by
							checking your voting status in your dashboard, but you won't be
							able to verify individual vote hashes.
						</p>
					</div>
					...
					<div>
						...
						<p className="text-muted-foreground text-sm">
							Yes, anyone can verify any vote hash. However, you need the exact
							hash to verify a vote. Hashes are unique and cannot be guessed,
