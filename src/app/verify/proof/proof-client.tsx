					...
					<div className="grid gap-6 md:grid-cols-2">
						<div>
							...
							<p className="text-muted-foreground text-sm">
								All vote hashes are organized into a binary tree structure. Each
								parent node is the hash of its two children, creating a single
								root hash at the top.
							</p>
						</div>
						...
						<div>
							...
							<p className="text-muted-foreground text-sm">
								To prove a vote is in the tree, you only need the sibling hashes
								along the path from your vote to the root. This is much smaller
								than the full tree.
							</p>
						</div>
