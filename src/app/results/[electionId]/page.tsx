		...
		<div className="container mx-auto space-y-6 p-6">
			...
			<div className="grid gap-4 md:grid-cols-3">
				...
				<Card>
					...
					<CardContent>
						<div className="space-y-2">
							<div className="font-bold text-3xl">{results.ballots.length}</div>
							<div className="text-muted-foreground text-sm">
				...
				<CardContent className="space-y-4">
					...
					<div className="grid gap-4 md:grid-cols-2">
						<div className="rounded-lg border p-4">
							...
							<p className="text-muted-foreground text-sm">
								All votes are cryptographically hashed and stored immutably. No
								votes can be modified after casting.
							</p>
						</div>
						<div className="rounded-lg border p-4">
							<h4 className="mb-2 font-medium">Voter Anonymity</h4>
							<p className="text-muted-foreground text-sm">
								Vote records are completely anonymous. There is no way to link a
								vote to a specific voter's identity.
							</p>
						</div>
					</div>
				</CardContent>
